...
#define HID_DEVICE_NOT_FOUND				0x01	//not use
#define HID_DEVICE_NOT_OPENED				0x02	//not use
#define HID_DEVICE_ALREADY_OPENED			0x03	//not use
#define	HID_DEVICE_TRANSFER_TIMEOUT			0x04
#define HID_DEVICE_TRANSFER_FAILED			0x05	//not use
#define HID_DEVICE_CANNOT_GET_HID_INFO		0x06	//not use
#define HID_DEVICE_HANDLE_ERROR				0x07	//not use
#define HID_DEVICE_INVALID_BUFFER_SIZE		0x08	//not use
#define HID_DEVICE_SYSTEM_CODE				0x09	//not use
#define HID_DEVICE_UNSUPPORTED_FUNCTION		0x0A	//not use
#define HID_DEVICE_UNKNOWN_ERROR			0xFF	//not use

// Max number of USB Devices allowed
#define MAX_USB_DEVICES					64	//not use

// Max number of reports that can be requested at time
#define MAX_REPORT_REQUEST_XP			512	//not use
#define MAX_REPORT_REQUEST_2K			200	//not use

#define DEFAULT_REPORT_INPUT_BUFFERS	0	//not use

// String Types
#define HID_VID_STRING					0x01	//not use
#define HID_PID_STRING					0x02	//not use
#define HID_PATH_STRING					0x03	//not use
#define HID_SERIAL_STRING				0x04	//not use
#define HID_MANUFACTURER_STRING			0x05	//not use
#define HID_PRODUCT_STRING				0x06	//not use

// String Lengths
#define MAX_VID_LENGTH					5	//not use
#define MAX_PID_LENGTH					5	//not use
#define MAX_PATH_LENGTH					MAX_PATH
#define MAX_SERIAL_STRING_LENGTH		256	//not use
#define MAX_MANUFACTURER_STRING_LENGTH	256	//not use
#define MAX_PRODUCT_STRING_LENGTH		256	//not use
#define MAX_INDEXED_STRING_LENGTH		256	//not use
